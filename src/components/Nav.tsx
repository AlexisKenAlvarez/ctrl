  ...
  return (
    <nav className="sticky left-0 top-0 z-50 mx-auto w-full bg-white">
      <nav className="mx-auto w-full p-5">
        <div
          className={cn("mx-auto flex items-center justify-between gap-3", {
        ...
        >
          ...
          >
            <Input
              ...
              onKeyDown={async (e) => {
                ...
                if (e.key === "ArrowDown") {
                  ...
                  if ((selected === null || result.length <= 0) && search !== "") {
              ...
              placeholder="Search for testing center"
              onChange={(e) => {
            ...
            <Button className="absolute bottom-0 right-2 top-0 my-auto h-9 w-9 rounded-full bg-blue hover:bg-blue/80">
